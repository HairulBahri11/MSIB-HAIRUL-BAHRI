...
<div class="card mb-4">
    <div class="card-header">
        ...
        <a href="index.php?url=productForm" class="btn btn-primary btn-sm">Tambah</a>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                foreach ($data_produk as $data) { ?>
                    <tr>
                        ...
                        jika user staff button action hide 
                        jika user admin button action show
                        <?php if ($sesi['role'] == 'admin') { ?>
                            <form action="controller/productController.php" method="POST">
                                ...
                                <a class="btn btn-warning btn-sm" href="index.php?url=productForm&iedit=<?= $data['id'] ?>">Ubah</a>
