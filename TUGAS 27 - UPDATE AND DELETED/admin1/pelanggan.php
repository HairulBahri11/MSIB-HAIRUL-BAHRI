...
<div class="card mb-4">
    <div class="card-header">
        ...
        <a href="index.php?url=pelangganForm" class="btn btn-primary btn-sm">Tambah</a>
    </div>
    <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="controller/pelangganController.php" method="POST">
                                ...
                                <a class="btn btn-warning btn-sm" href="index.php?url=pelangganForm&iedit=<?= $data['id'] ?>">Ubah</a>
